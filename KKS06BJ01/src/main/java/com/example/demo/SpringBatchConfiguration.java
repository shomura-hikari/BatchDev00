...
//    private StepBuilder stepBuilderFactory;
    ...
    @Bean
    public Step step(KKS06BJ01Ser KKS06BJ01Ser, JobRepository jobRepository, PlatformTransactionManager transactionManager) {
        return new StepBuilder("HelloWorld", jobRepository)
                .tasklet(KKS06BJ01Ser, transactionManager).build();
    }
